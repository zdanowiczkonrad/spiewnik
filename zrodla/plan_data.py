...
SELECTED=[
 ...
 "Bo góry mogą ustąpić","Chlebie najcichszy",
 "Chrystus Pan Boży Syn","Cóż Ci Jezu damy","Dotknij, Panie, moich oczu","Dzięki Ci, Panie, za Ciało Twe i Krew",
 "Idzie mój Pan","Jeden chleb","Kochajmy Pana","Memu Bogu, Królowi","Mów do mnie, Panie",
 "O Zbawcza Hostio","Oceany","Oto ja, poślij mnie",
 "Oto jest dzień","Otwórz me oczy, o Panie","Pan blisko jest","Pan jest mocą swojego ludu","Pan wywyższony","Panie dobry jak chleb",
 "Przed tak wielkim Sakramentem","Przyjdź jak deszcz","Skosztujcie i zobaczcie",
 "Ta krew z grzechu obmywa mnie","Twoja miłość","Tyś jest Bóg, wywyższamy Cię","Ukaż mi, Panie, swą twarz",
 "W lekkim powiewie","Wciąż mnie zadziwiasz, Panie",
 "Witaj Pokarmie","Wspaniały Dawco miłości","Wszystko Tobie oddać pragnę","Zbliżam się w pokorze",
]
...
PLAN=[
 ("Czwartek · 4 czerwca","Uroczystość Najświętszego Ciała i Krwi Chrystusa (Boże Ciało)","msza kameralna · Rok A",
  ...
  [("Wejście","Oto jest dzień","Radość uroczystości — „weselmy się i radujmy się w nim”."),
   ...
   ("Komunia","Idzie mój Pan","Pan „biegnie, by w Komunii nakarmić nasz głód” — nowa manna (echo Pwt 8 i J 6)."),
   ...
   ("Wyjście","Chrystus Pan Boży Syn","„O żywy Chlebie nasz w tym Sakramencie” — uwielbienie Chrystusa obecnego w Najświętszym Sakramencie."),
   ("Adoracja","Twoja miłość · W lekkim powiewie · Witaj Pokarmie · Zbliżam się w pokorze","Wyciszone trwanie przy Panu obecnym w Hostii. 3–4 pieśni.")]),
 ("Piątek · 5 czerwca","Piątek IX tygodnia zwykłego, św. Bonifacego","msza kameralna",
  ...
  [("Wejście","Dotknij, Panie, moich oczu","Prośba o otwarcie oczu, warg i serca na Słowo."),
   ...
   ("Wyjście","Pan wywyższony","Posłanie z uwielbieniem — „Pan wywyższony, nasz Król” (Mesjasz Panem Dawida, Mk 12)."),
 ...
 ("Sobota · 6 czerwca","Sobota IX tygodnia zwykłego, św. Norberta","msza kameralna",
  ...
  [("Wejście","Przyjdź jak deszcz","Prośba o ożywienie i świeżość Ducha na nowy dzień."),
   ...
   ("Komunia","Zbliżam się w pokorze","Pokorne zbliżenie do Pana ukrytego w Sakramencie — jak wdowa, która oddaje wszystko."),
   ...
   ("Adoracja","Pan blisko jest · Oceany · Tyś jest Bóg, wywyższamy Cię","Zawierzenie i uwielbienie — „Pan blisko jest, oczekuj Go”. 3 pieśni.")]),
